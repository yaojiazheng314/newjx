					...
					<el-tab-pane>
						...
						<el-table
							...
							<el-table-column prop="calcType" label="转换">
								<template slot-scope="scope">
									<el-tag 
										v-if="scope.row.calcType === 'ptp'"
										type="warning"
										size="mini">
										人员
									</el-tag>
									<el-tag 
										v-else-if="scope.row.calcType === 'dtp'"
										type="info"
										size="mini">
										科室转人员
									</el-tag>								
					...
					<el-tab-pane>
						...
						<el-table
							...
							<el-table-column prop="calcType" label="转换">
								<template slot-scope="scope">
									<el-tag 
										v-if="scope.row.calcType === 'dtp'"
										type="info"
										size="mini">
										科室转人员
									</el-tag>
									<el-tag 
										v-else-if="scope.row.calcType === 'ptp'"
										type="warning"
										size="mini">
										人员
									</el-tag>								
...
<script>
	import { getPerRunDetails } from '@/api/bnsForPerRun'
	export default {
		props: {
			dialogFormVisible: {
				type: Boolean
...
// 				searchUnUse: '',
		...
		created() {
			this.visable = this.dialogFormVisible
		},
		mounted() {
		...
		methods: {
			getRunDetail() {
				...
				getPerRunDetails(query).then(response => {
