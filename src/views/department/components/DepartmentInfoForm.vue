<template>
	<div id="departmentInfoForm" v-show="formVisible">
		<el-row :gutter="20">
			<el-col :span="14">
				<el-card style="height: 510px;">
					<div slot="header" class="clearfix">
						<span>{{ departmentForm.name }}</span>
					</div>
					<el-form 
						ref="departmentForm"
						:rules="rules"
						...
						<el-form-item label="类别" prop="category">
							<el-radio-group 
								...
								<el-radio-button 
									label="门诊住院" value="门诊住院"></el-radio-button>
						...
						<el-form-item style="margin-left: 200px;">
							...
							<el-button 
								type="primary"
								class="guo-btn light-flower-blue-btn"
...
<!-- 		<el-row>
			<line-chart style="margin-top: 80px;"></line-chart>
		</el-row> -->
	</div>
</template>
...
export default {
	...
	methods: {
		getDepartmentInfo() {
			...
			self.departmentForm = Object.assign({}, data)
		},
		getDepartmentParams() {
			var self = this
