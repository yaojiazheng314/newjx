<template>
	<div class="app-container">
      ...
      <el-table-column prop="modifyreason" label="调整原因">
			</el-table-column>
      ...
      <el-table-column prop="departmentCode1" label="科室编码">
			</el-table-column>
			<el-table-column prop="deptmentName1" label="调增科室">
			</el-table-column>
			<el-table-column prop="hospName1" label="科室院属">
			</el-table-column>
			<el-table-column prop="originalValue1" label="调增原始值" :formatter="handleFormat" align="right" width="100">
			</el-table-column>
			<el-table-column prop="ratio1" label="调增率">
			</el-table-column>
			<el-table-column prop="modifyValue1" label="调增值" :formatter="handleFormat" align="right" width="100">
			</el-table-column>
			<el-table-column prop="modifyTypeName2" label="调减类型">
			</el-table-column>
			<el-table-column prop="mzbs2" label="科室属性">
			</el-table-column>
      <el-table-column prop="departmentCode2" label="科室编码">
			</el-table-column>
			<el-table-column prop="deptmentName2" label="调减科室">
			</el-table-column>
			<el-table-column prop="hospName2" label="科室院属">
			</el-table-column>
			<el-table-column prop="originalValue2" label="调减原始值" :formatter="handleFormat" align="right" width="100">
			</el-table-column>
			<el-table-column prop="ratio2" label="调减率">
			</el-table-column>
			<el-table-column prop="modifyValue2" label="调减值" :formatter="handleFormat" align="right" width="100">
			</el-table-column>
...
export default {
  directives: { waves },
  name: "Person",
  components: { PersonEditDialog, DataNewDialog },
  directives: { waves },
  data() {
    return {
      list: null,
  ...
  methods: {
    ...
    getList() {
      ...
      fetchIncomeAdjustDataList(query).then(response => {
        self.list = response.data.incomeAdjustData;
        self.total = response.data.total;
        self.sumAdd = response.data.sumAdd.toFixed(2);
        self.sumSub = response.data.sumSub.toFixed(2);
        self.sum=(Number(self.sumAdd) +Number(self.sumSub)).toFixed(2);
