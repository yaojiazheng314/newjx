  ...
  <!-- 编辑树形弹窗 -->
      ...
      <el-form 
        ...
        <el-row>
         ...
         <el-row>
          <el-col :span="12">
            <el-form-item label="目标值类型:" prop="relation" v-if="treeForm.hasBasis == 1">
              <el-select 
                v-model="treeForm.targetValuesType" 
                filterable clearable 
                placeholder="选择目标值类型" 
              >
                <el-option 
                  v-for="item in targetvaluestype_option" 
                  :key="item.value" 
                  :label="item.text" 
                  :value="item.value">
          ...
          <el-col :span="12">
             <el-form-item label="最高得分:" prop="topscore" v-if="treeForm.hasBasis == 1">
               	<el-input 
                v-model.trim="treeForm.topscore" 
                placeholder="请输入最高得分"
                type="number"
                style="width: 200px;">
              </el-input>
        ...
        <el-row v-if="treeForm.targetValuesType === 1">
          <el-col :span="12">
            <el-form-item label="与目标值关系:" prop="relation" v-if="treeForm.hasBasis == 1">
              <el-select 
                v-model="treeForm.relation" 
                filterable clearable 
          ...
          <el-col :span="12">
             <el-form-item label="目标值:" prop="targetvalues" v-if="treeForm.hasBasis == 1">
               	<el-input 
                v-model="treeForm.targetvalues" 
                placeholder="请输入目标值"
                type="number"
                style="width: 200px;">
              </el-input>
        ...
        <el-row v-if="treeForm.targetValuesType === 0">
          <el-col :span="12">
            <el-form-item label="目标值选项:" prop="tagetValuesSelect" v-if="treeForm.hasBasis == 1">
              <el-select 
                v-model="treeForm.tagetValuesSelect" 
                filterable clearable 
                placeholder="选择目标值类型" 
              >
                <el-option 
                  v-for="item in tagetvaluesselect_option" 
                  :key="item.value" 
                  :label="item.text" 
                  :value="item.value">
...
export default {
  ...
  data() {
    return {
      ...
      relation_option:[
        ...
        targetvaluestype_option:[
          {value:0,text:"非数值"},
          {value:1,text:"数值"}
        ],
        tagetvaluesselect_option:[
          {value:0,text:"无"},
          {value:1,text:"有"}
        ]
    };
  ...
  methods: {
    ...
    treeAppend(data) {
      ...
      this.treeForm.relation ="";
      this.treeForm.targetvalues = "";
      this.treeForm.targetValuesType = "";
      this.treeForm.topscore ="";
    ...
    treeUpdata(data) {
      ...
      this.treeForm.levelId = data.levelId;
      this.treeForm.relation = data.relation;
      this.treeForm.targetvalues = data.targetValues;
      this.treeForm.targetValuesType = data.targetValuesType;
      this.treeForm.topscore = data.topScore;
      this.treeForm.tagetValuesSelect = data.tagetValuesSelect;
      this.treeForm.targetValuesType = data.targetValuesType;
    ...
    treeSave() {
      let data = {
        ...
        "relation":this.treeForm.relation,
        "targetvalues":this.treeForm.targetvalues,
        "targetValuesType":this.treeForm.targetValuesType,
        "topscore":this.treeForm.topscore,
        "tagetValuesSelect":this.treeForm.tagetValuesSelect
      }
      saveAimTarget(data).then(res=>{
        this.treeShow = false;
        this.setInitPage();
      })
    },
    ...
    sourcesSave() {
      ...
      if(this.type == 'target'){
        ...
        addAimDataSource(data).then(res=>{
          this.sourcesShow = false;
          this.setInitPage();
        })
      }else{
